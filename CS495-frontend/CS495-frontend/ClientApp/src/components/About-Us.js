    ...
    render() {
        return (
            <>
                ...
                <div className="pink-block2">
                </div>
                <div className="pink-block3">
                </div>
                <div className="firsttext">
                    <h1></h1>
                </div>
                <div className="firstinformation">
                    <p>Our mission is to consolidate resources and information regarding Japanese culture in the United States, starting  with the southeastern region our plan is to grow to encompass the entire United State. We aim to provide information on events, organizations, and culture in general.</p>
                    <br></br>
                    <br></br>
            ...
            <div className="quarter-screen-container">
                <div className="text-and-image">
                    ...
                    <img src={require('../assets/pinkumbrella.jpeg')} className="centered-image" />
                </div>
            </div>
            ...
            <div className="quarter-screen-container2">
                <div className="text-and-image">
                    ...
                    <img src={require('../assets/pinktree.jpeg')} className="centered-image" />
                </div>
            </div>
